...
class CartRepository:
    ...
    @staticmethod
    async def get_item_by_cart_and_product(db: AsyncSession, cart_id: uuid.UUID, product_id: uuid.UUID) -> CartItem | None:
        stmt = (
            select(CartItem)
    ...
    @staticmethod
    async def add_item(db: AsyncSession, cart_id: uuid.UUID, product_id: uuid.UUID, quantity: int) -> CartItem:
    ...
    @staticmethod
    async def update_item_quantity(db: AsyncSession, item_id: uuid.UUID, quantity: int) -> CartItem | None:
